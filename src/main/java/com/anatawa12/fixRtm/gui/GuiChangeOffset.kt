...
class GuiChangeOffset(private var tileEntity: TileEntityPlaceable) : GuiScreenCustom() {
    ...
    override fun initGui() {
        ...
        fieldOffsetX = setFloatField(width - 70, 20, 60, 20, tileEntity.offsetX.toString())
        fieldOffsetY = setFloatField(width - 70, 50, 60, 20, tileEntity.offsetY.toString())
        fieldOffsetZ = setFloatField(width - 70, 80, 60, 20, tileEntity.offsetZ.toString())
        fieldRotationYaw = setFloatField(width - 70, 110, 60, 20, tileEntity.rotation.toString())
    }
